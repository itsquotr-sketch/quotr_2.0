...
| **3.2** | Builder Interview | Structured interview capture aligned with constraints and DNA evidence | **In Progress** — **3.2.0 Complete Planning**; **3.2.0-R1 Complete**; **3.2.1 Complete**; **3.2.2 Complete Local** (Owner Preview Pending); **3.2.3 Not Started**; stage not globally Complete |
...
| **3.2.2** | Core project/site constraint interview | Ask-layer wiring into Assistant; Constraint writes | **Complete Local** (2026-08-12) — Owner Preview Pending |
...
- Status: **3.2.2 Complete Local** (Owner Preview Pending); **3.2.3 Not Started**; Production Scope Discovery **Disabled**; Company DNA **Not Started**
...
- 3.2.2 preview runbook: `docs/runbooks/STAGE_3_2_2_CORE_SITE_INTERVIEW_PREVIEW_TEST.md`
