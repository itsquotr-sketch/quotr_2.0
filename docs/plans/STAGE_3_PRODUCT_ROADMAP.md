...
| **3.2** | Builder Interview | Structured interview capture aligned with constraints and DNA evidence | **In Progress** — **3.2.2 In Owner Preview / R3 Complete Local**; **3.2.3 Not Started**; stage not globally Complete |
...
| **3.2.2** | Core project/site constraint interview | Ask-layer wiring into Assistant; Constraint writes | **In Owner Preview / R3 Complete Local** (2026-08-13) — Owner Demo Preview Pending |
...
- Status: **3.2.2 In Owner Preview / R3 Complete Local**; **3.2.3 Not Started**; Production Scope Discovery **Disabled**; Company DNA **Not Started**
