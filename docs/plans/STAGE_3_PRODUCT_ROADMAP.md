...
| **3.1B** | Intelligent Scope Discovery | Smarter work-area / question discovery without redesigning commercial arithmetic | **In Progress** — 3.1B.7C Complete — Local; 3.1B.7B Complete — Local; 3.1B.7A Complete — Local; 3.1B.6R3.1 Preview Retest Pending; 3.1B.7D / 3.1B.7 Not Started; UI/UX Overhaul In Progress; Scope Discovery Preview sign-off Pending; Production Disabled; Analyse Job Preserved |
