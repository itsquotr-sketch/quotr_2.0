...
| **3.1B** | Intelligent Scope Discovery | Smarter work-area / question discovery without redesigning commercial arithmetic | **In Progress** — 3.1B.7E Complete — Local / **BLOCKED BY PREVIEW DEFECTS** (Owner E2E); 7A–7D Complete — Local; Preview flag fixed; Production Disabled; Analyse Job Preserved |
