...
| **3.1B** | Intelligent Scope Discovery | Smarter work-area / question discovery without redesigning commercial arithmetic | **In Progress** — 3.1B.6R2 Complete — Local, Preview Retest Pending; 3.1B.7 Not Started; Production Disabled; Analyse Job Preserved |
