...
| **3.1B** | Intelligent Scope Discovery | Smarter work-area / question discovery without redesigning commercial arithmetic | **In Progress** — 3.1B.7D Complete — Local; 7A–7C Complete — Local; Assistant UX refinement Complete — Local; 3.1B.6R3.1 Preview Retest Pending; Stage 3.1B release hardening Ready Pending Preview Sign-off; Scope Discovery Preview sign-off Pending Owner Test; Pricing/Quote UX Planned; Production Disabled; Analyse Job Preserved |
