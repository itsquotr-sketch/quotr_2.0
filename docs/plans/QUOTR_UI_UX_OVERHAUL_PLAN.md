...
| Calibration | Deck/Bathroom evidence MVP + remote 033 | **3.1C.3-R2D–R2D.2** Complete — Preview Validated |
| First-run Preview polish | Coherent Basics→Dashboard→optional Setup E2E | **3.1C.3-R2E** Complete — Preview Validated |
| Preview remediation | Blank Basics hard-nav; deep links; calibration sticky | **3.1C.3-R2E-R1** Complete — Preview Validated |
| Stage 3.1C overall | Auth + first-run Setup | **Complete — Preview Validated** (`STAGE_3_1C_CLOSURE.md`) |
| UX-E | Pricing + Quote surfaces | **Planned separately** |

**Production Scope Discovery:** Disabled  
**Stage 3.2:** In Owner Preview — **3.2.2-R5 Complete Local / Owner Demo Preview Pending** (`STAGE_3_2_2_R5_DEMO_UI_POLISH_COMPLETION.md`); **3.2.3 Not Started**  
