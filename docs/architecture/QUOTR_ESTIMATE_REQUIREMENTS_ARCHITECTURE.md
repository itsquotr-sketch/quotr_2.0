...
**Status:** … REQ-4 **COMPLETE / COMPONENT AUTHORITY MIGRATION VALIDATED**. REQ-4B **COMPLETE / REMOTE VALIDATED**.  
...
**Next implementation:** REQ-4 complete. Deck surface is the first **requirement-authoritative** component. **DECK-1** is next (structural material quantities). Do not start DECK-1 here.
