...
**Status:** Open — Owner E2E Pending (Deck R4 PASS; R5 final UX/perf retest required; Bathroom FUNCTIONAL PASS; Fitout R6-R4.1 Local Complete / Owner retest Pending)  
**Updated:** 2026-08-11  
...
**7F-R6-R2 Fitout retest:** `docs/runbooks/STAGE_3_1B7FR6R2_COMMERCIAL_FITOUT_RETEST.md`  
...
**7F-R6-R4 / R4.1 Fitout retest:** `docs/runbooks/STAGE_3_1B7FR6R4_FINAL_FITOUT_RETEST.md`  
**7F-R6-R4 / R4.1 completion:** `docs/implementation/STAGE_3_1B7FR6R4_ATTENTION_ROUTING_COMPLETION.md`  
...
| FITOUT-R6R4-01 | Fitout | Medium/High | Seismic attention says Review in Scope Details with no Review action | Honest CTA/target contract | Mapped Fact with no question + actionable default | Yes until Owner Fitout retest | **Fixed — Local (7F-R6-R4)** superseded by R4.1 Owner path | `verify-stage-3-1b7fr6r4` + Owner |
| FITOUT-R6R41-01 | Fitout | Medium/High | Scope-level attention (Seismic) had no useful Review action | SCOPE → Review scope → Scope Review | R6-R4 removed fake CTA but left dead/non-routed attention | Yes until Owner Fitout retest | **Fixed — Local (7F-R6-R4.1)** Owner retest Pending | `verify-stage-3-1b7fr6r4` + Owner |
