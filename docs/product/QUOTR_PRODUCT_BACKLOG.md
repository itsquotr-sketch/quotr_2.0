...
**Status:** Active  
**Created:** 2026-08-05  
**Governing stage:** Stage 3.1A **Complete**; Stage 3.1D **Complete**; Stage 3.1B **In Progress** (3.1B.1–3.1B.4B Complete — Local; 3.1B.5 Ready Pending Acceptance Lifecycle Gate)  
...
**Constraint:** Items marked Deferred must not be implemented until authorised; deferred schema proposals remain **Not Approved**; migration 028 Complete — Local, Not Applied Remotely; AI provider adapter Implemented but unused; UI / production catalogue adoption Not Started  
...
- Stage 3.1B.5 accept/reject: **Ready Pending Acceptance Lifecycle Gate**.
- Migrations: `028` local only; UI **Not Started**; production adoption **Not Started**.
