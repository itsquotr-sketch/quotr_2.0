...
**Status:** Active  
**Created:** 2026-08-05  
**Governing stage:** Stage 3.1A **Complete**; Stage 3.1D **Complete**; Stage 3.1B **In Progress**; Auth **3.1C.2A/2B Preview-passed**; **3.1C.3 Local**; **3.1C.3-R1 Planning Complete**; **3.1C.3-R2A Complete — Local** (Preview Pending); **3.1C.3-R2B Complete — Local** (Preview Pending); **R2C Ready Next**; Production Scope Discovery **Disabled**; Stage 3.2 **Not Started**. Stage 3.1C **not** closed until R2E Preview.   
