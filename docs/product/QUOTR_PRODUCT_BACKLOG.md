...
**Status:** Active  
**Created:** 2026-08-05  
**Governing stage:** Stage 3.1A **Complete**; Stage 3.1D **Complete**; Stage 3.1B **In Progress** (3.1B.1–3.1B.3 Complete — Local; 3.1B.4 Ready Pending Persistence Owner Gate)  
...
**Constraint:** Items marked Deferred must not be implemented until authorised; deferred schema proposals remain **Not Approved**; migrations Not Approved; AI provider adapter Implemented but unused; UI / production catalogue adoption Not Started  
...
- Stage 3.1B.4 orchestration: **Ready Pending Persistence Owner Gate**.
- Migrations **Not Approved**; UI **Not Started**.
- FEAT-001 Deferred (intersects 3.1B.6); FEAT-002 Deferred; FEAT-003 Deferred until Builder Interview.
- Do not change Analyse Job behaviour, AI prompts (except dedicated unused discovery prompt), commercial formulas, or Company DNA without explicit authorisation.
