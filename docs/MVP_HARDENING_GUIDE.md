...
| 3 | Core project workflow | Complete | 2026-08-05 | 2026-08-05–2026-08-13 | **3.1A/D Complete**. **3.1C Complete — Preview Validated**. **3.1B Complete — Preview Validated**. Scope Discovery Production off. **3.2.0 / 3.2.0-R1 / 3.2.1 Complete**; **3.2.2 In Owner Preview / R3 Complete Local**; **3.2.3 Not Started**. | PERF-FUTURE-01 Planned; next R3 Owner Demo Preview then 3.2.3 when authorised. | `docs/implementation/STAGE_3_2_2_R3_DEMO_READY_ESTIMATE_UX.md`; `docs/plans/STAGE_3_2_BUILDER_INTERVIEW_PLAN.md` |
