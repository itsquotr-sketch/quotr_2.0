...
| 2B | Authoritative Pricing Engine | In Progress | 2026-08-04 | 2026-08-04 (kernel) | Batches 2B.3A–2B.3C complete: standalone kernel, golden regression (60 fixtures), canonical contract/replay (`2B.3C.0`). No pricing/estimate/quote behaviour change. | Next: 2B.4 / 2B.5 before adoption. Live GST overwrite bug (C-28) still scheduled for 2B.6. | `lib/commercial-engine/`; `scripts/verify-batch-2b3b-*.ts`; `scripts/verify-batch-2b3c-engine-contract.ts`; `docs/specifications/COMMERCIAL_ENGINE_CONTRACT.md`; `docs/implementation/STAGE_2B_BATCH_2B3C_COMPLETION.md` |
...
| Next stage | Stage 2B — Authoritative Pricing Engine (**In Progress**). Batches **2B.3A–2B.3C** complete (kernel + goldens + contract/replay). **No application adoption.** Next authorised batch: 2B.4 or 2B.5. No existing live pricing behaviour changed. |
