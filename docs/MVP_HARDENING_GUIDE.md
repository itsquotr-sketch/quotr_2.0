...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS**. Auth: **032 Applied Remote**; **3.1C.2A Account/Profile Complete — Local** (menu, logout, `/app/profile`, password change). | Owner Preview auth + account/profile tests; 3.1C.2B next. Production Scope Discovery off. | `docs/implementation/STAGE_3_1C2A_ACCOUNT_PROFILE_COMPLETION.md`; `docs/runbooks/STAGE_3_1C2A_ACCOUNT_PROFILE_PREVIEW_TEST.md` |
