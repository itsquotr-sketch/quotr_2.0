...
| 3 | Core project workflow | Complete | 2026-08-05 | 2026-08-05–2026-08-11 | **3.1A/D Complete**. **3.1C Complete — Preview Validated**. **3.1B Complete — Preview Validated** (Deck/Bathroom/Fitout PASS; closure `441f36c`). Scope Discovery Production off. **3.2.0 Complete Planning**; **3.2.1 Awaiting Owner Decisions**. | PERF-FUTURE-01 Planned; Production Scope Discovery enablement separate; Owner approve 3.2 D1–D10 before 3.2.1. | `docs/implementation/STAGE_3_1B_CLOSURE.md`; `docs/plans/STAGE_3_2_BUILDER_INTERVIEW_PLAN.md`; `docs/decisions/STAGE_3_2_BUILDER_INTERVIEW_OWNER_DECISIONS.md` |
...
| Next stage | Stage **3.2 Builder Interview** — **3.2.0 Complete Planning**; **3.2.1 Awaiting Owner Decisions** (`docs/decisions/STAGE_3_2_BUILDER_INTERVIEW_OWNER_DECISIONS.md`). Stage 3.2 not In Progress beyond planning. Stage 3.1B **Complete — Preview Validated** (`441f36c`). Production Scope Discovery **Disabled**. PERF-FUTURE-01 **Planned**. |
