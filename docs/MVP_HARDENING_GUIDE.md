...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete (Preview signed off). Stage 3.1C Complete. Stage 3.1B **Planning** (3.1B.0 audit/spec complete; not In Progress). | Clear owner decisions; then authorise 3.1B.1. Deferred schema Not Approved. FEAT-001–003 Deferred. | `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/audits/STAGE_3_1B_SCOPE_DISCOVERY_CURRENT_STATE_AUDIT.md`; `docs/implementation/STAGE_3_1A_3_1D_PREVIEW_SIGNOFF.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **Planning** (3.1B.0 complete — `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`). Do not mark In Progress or implement ISD until owner decisions cleared. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
