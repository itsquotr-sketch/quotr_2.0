...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C Complete**. **3.1B Owner Preview E2E** — Deck R4 PASS; R5 Owner retest Pending; Bathroom FUNCTIONAL PASS (BATH-CD-01 commercial detail local); Fitout Pending (DEF-7E-003). Migrations 001–033 remote. | Owner runs `STAGE_3_1B7FR5_DECK_FINAL_RETEST.md` then Fitout. Scope Discovery Production off. | `docs/implementation/STAGE_3_1B_BATHROOM_COMMERCIAL_DETAIL_COMPLETION.md` |
