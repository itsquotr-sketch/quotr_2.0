...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS**. Stage **3.1C.1A/1B Auth Complete — Local** (transactional RPC + setup repair; migration **032** remote pending). | Owner Deck Preview retest; auth Preview blocked on 032 remote; 3.1C.2 next. Production Scope Discovery off. | `docs/implementation/STAGE_3_1C1B_TRANSACTIONAL_PROVISIONING_COMPLETION.md`; `docs/runbooks/STAGE_3_1C1B_REMOTE_MIGRATION_032_READINESS.md` |
