...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.3 Complete — Local; 3.1B.4 Ready Pending Persistence Owner Gate. | Authorise 3.1B.4 persistence when ready. Migrations Not Approved. AI adapter Implemented but unused. UI/production catalogue adoption Not Started. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B3_AI_DISCOVERY_PROVIDER_COMPLETION.md`; `docs/implementation/STAGE_3_1B2_SCOPE_RELATIONSHIP_CATALOGUE_COMPLETION.md`; `docs/implementation/STAGE_3_1B1_SUGGESTION_CONTRACT_COMPLETION.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.1–3.1B.3 **Complete — Local**. 3.1B.4 **Ready Pending Persistence Owner Gate**. Migrations Not Approved. AI provider adapter Implemented but unused. UI / production catalogue adoption Not Started. Analyse Job Unchanged. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
