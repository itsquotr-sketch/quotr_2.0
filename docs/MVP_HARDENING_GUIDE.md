...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-07 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (7F gate pack ready; DEF-7E-003 owner results pending). Preview flag fixed. 7A–7F Complete — Local (7F = pack only). | Owner fills 7F E2E results → A READY FOR OWNER PRODUCTION GATE or B BLOCKED (Production still off). Migrations 028/029 Applied; **no 030**. Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7F_OWNER_E2E_GATE_COMPLETION.md`; `docs/runbooks/STAGE_3_1B7F_OWNER_E2E_TEST_PACK.md`; `docs/audits/STAGE_3_1B7E_PREVIEW_DEFECT_REGISTER.md` |
...
| Next stage | Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (Owner E2E DEF-7E-003). 3.1B.7F Complete — Local (gate pack); owner results Pending. Production **Disabled**. Stage 3.2 **Not Started**. |
