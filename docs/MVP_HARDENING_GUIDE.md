...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C Complete**. **3.1B Owner Preview E2E** — Deck R4 PASS; R5 Owner retest Pending; Bathroom FUNCTIONAL PASS; Fitout R6-R1 Local Complete / Owner retest Pending (DEF-7E-003). Migrations 001–033 remote. | Owner runs `STAGE_3_1B7FR6R1_COMMERCIAL_FITOUT_RETEST.md` (+ Deck R5). Scope Discovery Production off. | `docs/implementation/STAGE_3_1B7FR6R1_SCOPE_DETAILS_SPECIFICATION_COMPLETION.md` |
...
| Next stage | Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (Owner E2E DEF-7E-003). 7F-R6 multi-WA Local Complete / Fitout Owner retest Pending; Production **Disabled**. Stage 3.2 **Not Started**. |
