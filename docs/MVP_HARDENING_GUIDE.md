...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.5A Complete — Local; 3.1B.5B Complete — Planning. | Owner-approve remote 028/029 (Preview), then server-action batch. Migrations Ready Pending Owner Approval. Wiring Ready Pending Remote Migration. Feature flag Planned. UI Not Started. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B5B_READINESS_COMPLETION.md`; `docs/decisions/STAGE_3_1B5B_REMOTE_AND_WIRING_APPROVAL.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.5B **Complete — Planning**. Migrations 028/029 **Ready Pending Owner Approval**. Production wiring **Ready Pending Remote Migration**. Feature flag **Planned**. UI **Not Started**. Analyse Job **Unchanged**. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
