...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-06 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.6 Complete — Local. | Preview UI smoke for 3.1B.6; then 3.1B.7. Migrations 028/029 Applied and Verified. Scope Discovery UI Complete — Local, Preview Test Pending. Production Disabled. Analyse Job Preserved. FEAT-001 partial; FEAT-002–003 Deferred. | `docs/implementation/STAGE_3_1B6_ASSISTANT_UI_COMPLETION.md`; `docs/runbooks/STAGE_3_1B6_SCOPE_DISCOVERY_PREVIEW_SMOKE_TEST.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.6 **Complete — Local**. Migrations 028/029 **Applied and Verified**. Scope Discovery UI **Complete — Local, Preview Test Pending**. Preview feature **owner-configured only**. Production **Disabled**. Feature flag **Implemented** (`SCOPE_DISCOVERY_ENABLED`, default off). Next: 3.1B.7 after Preview UI sign-off. Analyse Job **Preserved**. FEAT-001 partial; FEAT-002–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
