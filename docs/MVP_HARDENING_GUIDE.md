...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.4A Complete — Local; 3.1B.4B-0 Complete — Planning; 3.1B.4B Ready Pending Owner Approval. | Sign persistence owner approval before any SQL (`028`). Migration Not Approved. AI adapter Implemented but unused. UI/production adoption Not Started. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B4B0_PERSISTENCE_GATE_COMPLETION.md`; `docs/architecture/STAGE_3_1B4B_PERSISTENCE_ARCHITECTURE.md`; `docs/decisions/STAGE_3_1B4B_PERSISTENCE_OWNER_APPROVAL.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.1–3.1B.4A **Complete — Local**. 3.1B.4B-0 **Complete — Planning**. 3.1B.4B **Ready Pending Owner Approval**. Migration Not Approved (no `028` file). AI provider adapter Implemented but unused. UI / production adoption Not Started. Analyse Job Unchanged. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
