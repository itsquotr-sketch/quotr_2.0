...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-07 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (7F owner results pending; 7G density Complete — Local). Preview flag fixed. 7A–7G Complete — Local (7F = pack only). | Owner fills 7F E2E results (incl. 7G sticky/density checks) → A READY FOR OWNER PRODUCTION GATE or B BLOCKED (Production still off). Migrations 028/029 Applied; **no 030**. Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7G_ASSISTANT_DENSITY_STICKY_ESTIMATE_COMPLETION.md`; `docs/runbooks/STAGE_3_1B7F_OWNER_E2E_TEST_PACK.md`; `docs/audits/STAGE_3_1B7E_PREVIEW_DEFECT_REGISTER.md` |
