...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **Stage 3.1C Complete — Preview Validated**. Next: **3.1B Owner Preview E2E** (Deck / Bathroom / Fitout). Migrations 032–033 remote applied. | Owner 3.1B E2E pack. Scope Discovery Production off. DNA/Stage 3.2 not started. | `docs/implementation/STAGE_3_1C_CLOSURE.md` |
