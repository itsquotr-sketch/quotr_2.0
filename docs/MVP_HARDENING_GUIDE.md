...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C Complete**. **3.1B Owner Preview E2E Ready** — Deck/Bathroom/Fitout Pending (DEF-7E-003). Migrations 001–033 remote. | Owner runs `STAGE_3_1B_OWNER_PREVIEW_FINAL_SIGNOFF.md`. Scope Discovery Production off. | `docs/implementation/STAGE_3_1B_OWNER_PREVIEW_E2E_READINESS.md` |
