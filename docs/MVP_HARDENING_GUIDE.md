...
| Next stage | Stage **3.2.2-R5 Owner Demo Preview**; then Owner-gated **commercial P0 / cost-first** (`docs/plans/POST_3_2_2_COMMERCIAL_MATERIALS_PLAN.md`) and/or **3.2.3** when authorised. Production Scope Discovery **Disabled**. Company DNA **Not Started**. PERF-FUTURE-01 **Planned**. |
