...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-06 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.5C Complete — Local. | Preview server test for 3.1B.5C; then 3.1B.6 UI. Migrations 028/029 Applied and Verified. Server integration Complete — Local, UI Unwired. Preview enablement Ready Pending Owner Test. Production Disabled. Feature flag Implemented. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B5C_GATED_SERVER_INTEGRATION_COMPLETION.md`; `docs/runbooks/STAGE_3_1B5C_PREVIEW_SERVER_INTEGRATION_TEST.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.5C **Complete — Local**. Migrations 028/029 **Applied and Verified**. Server integration **Complete — Local**, UI Unwired. Preview enablement **Ready Pending Owner Test**. Production **Disabled**. Feature flag **Implemented** (`SCOPE_DISCOVERY_ENABLED`, default off). Next: 3.1B.6 after Preview server test. Analyse Job **Unchanged**. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
