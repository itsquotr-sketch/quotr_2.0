...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B Owner E2E Open. Auth: **3.1C.2A Preview-passed**; **3.1C.2B Complete — Local** (callback, forgot/reset, safe `next`); Preview Auth E2E Pending. | Owner Preview auth recovery E2E; 3.1C.3 Ready Next. Production Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C2B_ACCOUNT_RECOVERY_COMPLETION.md`; `docs/runbooks/STAGE_3_1C2B_ACCOUNT_RECOVERY_PREVIEW_TEST.md` |
