...
| Next stage | Stage **3.2.2-R5 Owner Demo Preview**; then **Cost-first Rates** (`docs/plans/COST_FIRST_RATES_UI_NEXT_BATCH.md`) after **COMMERCIAL-P0 Complete Local**; **3.2.3** when authorised. Production Scope Discovery **Disabled**. Company DNA **Not Started**. PERF-FUTURE-01 **Planned**. |
