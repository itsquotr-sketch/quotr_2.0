...
| 2B | Authoritative Pricing Engine | In Progress | 2026-08-04 | 2026-08-04 (kernel) | Batches 2B.3A + 2B.3B complete: standalone `lib/commercial-engine/` + golden regression suite (60 fixtures pass). Blocking OCD decisions Confirmed. No pricing/estimate/quote behaviour change. | Next: 2B.4 / 2B.5 before adoption. Live GST overwrite bug (C-28) still scheduled for 2B.6. | `lib/commercial-engine/`; `scripts/verify-batch-2b3b-golden-commercial-engine.ts`; `docs/implementation/STAGE_2B_BATCH_2B3B_COMPLETION.md`; `docs/specifications/GOLDEN_SCENARIO_EXECUTION_MAP.md` |
...
| Next stage | Stage 2B — Authoritative Pricing Engine (**In Progress**). Batches **2B.3A** + **2B.3B** complete (standalone kernel + golden fixtures). **No application adoption.** Next authorised batch: 2B.4 or 2B.5. No existing live pricing behaviour changed. |
