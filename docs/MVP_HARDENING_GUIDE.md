...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-08 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (7F-R2 Local Complete; Preview retest Ready after 031 ACL). Preview flag fixed. 7A–7G + 7F-R1/R2 Complete — Local. | Owner Deck Preview retest → A or B (Production still off). Migrations **028–031 Applied and Verified** on Preview remote. Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7FR22_MANUAL_SCOPE_ACL_HARDENING_COMPLETION.md`; `docs/runbooks/STAGE_3_1B7FR2_DECK_PREVIEW_RETEST.md` |
