...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-08 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (7F-R2 Local Complete; Preview retest Pending). Preview flag fixed. 7A–7G + 7F-R1/R2 Complete — Local. | Owner fills 7F-R2 Deck retest → A READY FOR OWNER PRODUCTION GATE or B BLOCKED (Production still off). Migrations 028/029 Applied; **030 local only** (remote not applied). Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7FR2_FINAL_PREVIEW_POLISH_COMPLETION.md`; `docs/runbooks/STAGE_3_1B7FR2_DECK_PREVIEW_RETEST.md`; `docs/audits/STAGE_3_1B7E_PREVIEW_DEFECT_REGISTER.md` |
...
| Next stage | Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (Owner E2E DEF-7E-003). 3.1B.7F-R2 Complete — Local / Preview Retest Pending; Production **Disabled**. Stage 3.2 **Not Started**. |
