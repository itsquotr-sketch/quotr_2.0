...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.4A Complete — Local; 3.1B.4B Ready Pending Persistence Owner Approval. | Review persistence proposal before any SQL. Migrations Proposed, Not Approved. AI adapter Implemented but unused. UI/production adoption Not Started. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B4A_DISCOVERY_ORCHESTRATION_COMPLETION.md`; `docs/specifications/SCOPE_DISCOVERY_PERSISTENCE_PROPOSAL.md`; `docs/implementation/STAGE_3_1B3_AI_DISCOVERY_PROVIDER_COMPLETION.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.1–3.1B.4A **Complete — Local**. 3.1B.4B **Ready Pending Persistence Owner Approval**. Persistence migration Proposed, Not Approved. AI provider adapter Implemented but unused. UI / production adoption Not Started. Analyse Job Unchanged. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
