...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-07 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (7E): Preview flag fixed; Owner Deck/Bathroom/Fitout E2E pending. 7A–7D Complete — Local. | Owner Preview E2E + defect register clearance → READY FOR OWNER PRODUCTION GATE (Production still off). Migrations 028/029 Applied; **no 030**. Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7E_PREVIEW_RELEASE_HARDENING_COMPLETION.md`; `docs/audits/STAGE_3_1B7E_PREVIEW_DEFECT_REGISTER.md` |
...
| Next stage | Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (Owner E2E DEF-7E-003). 3.1B.7E Complete — Local. Production **Disabled**. Stage 3.2 **Not Started**. |
