...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-06 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.7A **Complete — Local**; 3.1B.6R3.1 Preview Retest Pending. | Preview validation of disclosure + Scope Discovery smoke; then 3.1B.7B / 3.1B.7. Migrations 028/029 Applied and Verified; **no 030**. Production Disabled. Analyse Job Preserved. | `docs/implementation/STAGE_3_1B7A_PROGRESSIVE_DISCLOSURE_COMPLETION.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.7B **Complete — Local**. 3.1B.7C / 3.1B.7 **Not Started**. UI/UX Overhaul **Planned**. Production **Disabled**. Analyse Job **Preserved**. |
