...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | **3.1C.3-R2A Complete — Local** (hard basics gate, NZ/AU currency). | Owner Preview R2A; R2B next. Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C3_R2A_FIRST_RUN_GATING_COMPLETION.md` |
