...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS**. Auth: **032 Applied Remote**; **3.1C.2A Complete — Local (not Preview-passed)**; **3.1C.2A-R1 Complete — Local** (missing `/app/profile` page was never in git deploy). | Owner Preview retest after R1 deploy; 3.1C.2B not started. Production Scope Discovery off. | `docs/implementation/STAGE_3_1C2A_R1_PROFILE_ROUTE_REMEDIATION.md`; `docs/runbooks/STAGE_3_1C2A_R1_PROFILE_ROUTE_PREVIEW_RETEST.md` |
