...
| 3 | Core project workflow | Complete | 2026-08-05 | 2026-08-05–2026-08-13 | **3.1A/D Complete**. **3.1C Complete — Preview Validated**. **3.1B Complete — Preview Validated** (3.1B.7F Owner E2E). Scope Discovery Production off. **3.2.0 / 3.2.0-R1 / 3.2.1 Complete**; **3.2.2 In Owner Preview / R5 Complete Local**; **3.2.3 Not Started**. | PERF-FUTURE-01 Planned; next R5 Owner Demo Preview; **COMMERCIAL-P0 Complete**; **Cost-first Rates Complete Local / Owner Preview Pending**; MaterialRequirement Not Started; 3.2.3 when authorised. | `docs/implementation/COST_FIRST_RATES_COMPLETION.md`; `docs/implementation/COMMERCIAL_P0_AUTHORITY_LOCK_COMPLETION.md`; `docs/plans/POST_3_2_2_COMMERCIAL_MATERIALS_PLAN.md` |
...
| Next stage | **REQ-2 COMPLETE / MATERIAL EMISSION FOUNDATION VALIDATED.** REQ-2.1 **COMPLETE / TECHNICALLY VALIDATED.** REQ-3 **COMPLETE / LABOUR EMISSION FOUNDATION VALIDATED.** REQ-3.1 **COMPLETE / TECHNICALLY VALIDATED** (Deck labour shadow). Next impl: **REQ-4** (`READY / NOT STARTED`). CM-03 **BACKLOG / NOT STARTED**. Contract `foundation-r1.1`. Production Scope Discovery **Disabled**. Company DNA **Not Started**. PERF-FUTURE-01 **Planned**. |
