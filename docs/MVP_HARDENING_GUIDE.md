...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1 Complete — Local; 3.1B.2 Ready. | Authorise 3.1B.2 catalogue. Migrations Not Approved. AI/UI Not Started. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B1_SUGGESTION_CONTRACT_COMPLETION.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/implementation/STAGE_3_1A_3_1D_PREVIEW_SIGNOFF.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.1 **Complete — Local** (`docs/implementation/STAGE_3_1B1_SUGGESTION_CONTRACT_COMPLETION.md`). 3.1B.2 **Ready**. Migrations Not Approved. AI provider / UI Not Started. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
