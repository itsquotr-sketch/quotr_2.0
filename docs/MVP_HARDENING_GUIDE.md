...
| 3 | Core project workflow | Complete | 2026-08-05 | 2026-08-05–2026-08-12 | **3.1A/D Complete**. **3.1C Complete — Preview Validated**. **3.1B Complete — Preview Validated** (Deck/Bathroom/Fitout PASS; 3.1B.7F Owner E2E; closure `441f36c`). Scope Discovery Production off. **3.2.0 / 3.2.0-R1 Complete**; **3.2.1 Complete Local** (D1–D16 APPROVED); **3.2.2 Not Started**. | PERF-FUTURE-01 Planned; Production Scope Discovery enablement separate; next 3.2.2 ask-layer wiring. | `docs/implementation/STAGE_3_1B_CLOSURE.md`; `docs/implementation/STAGE_3_1B7F_OWNER_E2E_GATE_COMPLETION.md`; `docs/implementation/STAGE_3_2_1_CANDIDATE_ENGINE_COMPLETION.md`; `docs/plans/STAGE_3_2_BUILDER_INTERVIEW_PLAN.md` |
...
| Next stage | Stage **3.2.2** Builder Interview ask-layer wiring — **3.2.1 Complete Local**; Stage 3.2 not globally Complete. Production Scope Discovery **Disabled**. Company DNA **Not Started**. PERF-FUTURE-01 **Planned**. |
