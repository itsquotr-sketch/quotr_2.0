...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-07 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.7D **Complete — Local**; 7A–7C Complete — Local; Assistant UX refinement Complete — Local; release hardening Ready Pending Preview Sign-off. | Owner Preview sign-off (7D matrix + Scope Discovery smoke); then 3.1B.7 missing-scope / hardening. Migrations 028/029 Applied and Verified; **no 030**. Production Disabled. Analyse Job Preserved. Pricing/Quote UX Planned separately. | `docs/implementation/STAGE_3_1B7D_FINAL_ASSISTANT_UX_COMPLETION.md`; `docs/runbooks/STAGE_3_1B7D_PREVIEW_RELEASE_SIGNOFF.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.7D **Complete — Local**. Assistant UX refinement **Complete — Local**. Stage 3.1B release hardening **Ready Pending Preview Sign-off**. Scope Discovery Preview sign-off **Pending Owner Test**. Production **Disabled**. Stage 3.2 **Not Started**. |
