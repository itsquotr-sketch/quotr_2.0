...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-06 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.6 Complete — Local; **3.1B.6R3.1 Complete — Local, Preview Retest Pending**. | Preview UI smoke for 3.1B.6R3.1; then 3.1B.7. Migrations 028/029 Applied and Verified; **no 030**. Scope Discovery UI Complete — Local, Preview Retest Pending. Production Disabled. Analyse Job Preserved. FEAT-001 partial; FEAT-002–003 Deferred. | `docs/implementation/STAGE_3_1B6R31_SCOPE_IMPACT_RECOMMENDATIONS_COMPLETION.md`; `docs/runbooks/STAGE_3_1B6R31_PREVIEW_RETEST.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.6R3.1 **Complete — Local, Preview Retest Pending**. UI/UX Overhaul **Planned**. Production **Disabled**. Analyse Job **Preserved**. 3.1B.7 **Not Started**. |
