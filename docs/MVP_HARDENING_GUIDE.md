...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | **3.1C.3-R2B Complete — Local** (WA preferences ≠ capability). | Owner Preview R2A/R2B; R2C next. Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C3_R2B_WORK_AREA_PREFERENCES_COMPLETION.md` |
