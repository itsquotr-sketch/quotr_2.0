...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B Owner E2E Open. Auth: **3.1C.2A/2B Preview-passed**. **3.1C.3 Complete — Local** (first-run company basics). | Owner Preview first-run E2E. Production Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C3_FIRST_RUN_COMPANY_SETUP_COMPLETION.md`; `docs/runbooks/STAGE_3_1C3_FIRST_RUN_PREVIEW_TEST.md` |
...
| 7 | Company setup and commercial configuration | In Progress | 2026-08-09 | 2026-08-09 | Stage 3.1C.3 first-run + readiness + Company Settings IA | Preview first-run E2E; deeper commercial config later | `docs/architecture/QUOTR_FIRST_RUN_AND_COMPANY_SETUP_ARCHITECTURE.md` |
...
| Next stage | Stage 3.1B **BLOCKED BY PREVIEW DEFECTS** (Owner E2E DEF-7E-003). 3.1B.7F-R3 Complete — Local / Final Deck Retest Pending; Production **Disabled**. Stage 3.2 **Not Started**. |
