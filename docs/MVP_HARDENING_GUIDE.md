...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C Complete**. **3.1B Owner Preview E2E** — Deck R4 PASS; R5 Owner retest Pending; Bathroom FUNCTIONAL PASS; Fitout R6 Local Complete / Owner retest Pending (DEF-7E-003). Migrations 001–033 remote. | Owner runs Deck R5 + `STAGE_3_1B7FR6_COMMERCIAL_FITOUT_RETEST.md`. Scope Discovery Production off. | `docs/implementation/STAGE_3_1B7FR6_MULTI_WORK_AREA_DATA_COLLECTION_COMPLETION.md` |
