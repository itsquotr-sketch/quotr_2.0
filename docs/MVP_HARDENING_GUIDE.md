...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C.3-R2D.1 Complete Local — Remote Pending** (calibration_responses 033; Save enabled locally). | Owner remote-approve 033; Preview R2A–R2D.1; R2E next. Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C3_R2D1_CALIBRATION_PERSISTENCE_COMPLETION.md` |
...
| 7 | Company setup and commercial configuration | In Progress | 2026-08-09 | 2026-08-09 | 3.1C.3 first-run Local; **R1 audit** of rates/calibration/gating | Owner decisions; R2A–R2E | `docs/architecture/QUOTR_RATE_AND_CALIBRATION_ARCHITECTURE.md`; `docs/decisions/STAGE_3_1C3_SETUP_OWNER_DECISIONS.md` |
