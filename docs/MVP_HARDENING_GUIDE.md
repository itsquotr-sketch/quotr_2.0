...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A/3.1D Complete. Stage 3.1B **In Progress**: 3.1B.1–3.1B.4B Complete — Local; 3.1B.5 Ready Pending Acceptance Lifecycle Gate. | Authorise 3.1B.5 accept lifecycle when ready. Migration 028 Local, Not Applied Remotely. AI adapter Implemented but unused. UI/production adoption Not Started. Analyse Job Unchanged. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1B4B_PERSISTENCE_COMPLETION.md`; `docs/decisions/STAGE_3_1B4B_PERSISTENCE_OWNER_APPROVAL.md`; `docs/plans/STAGE_3_1B_INTELLIGENT_SCOPE_DISCOVERY_PLAN.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1B **In Progress**. 3.1B.1–3.1B.4B **Complete — Local**. 3.1B.5 **Ready Pending Acceptance Lifecycle Gate**. Migration 028 Local, Not Applied Remotely. AI provider adapter Implemented but unused. UI / production adoption Not Started. Analyse Job Unchanged. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
