...
| Next stage | Stage **3.2.2-R5 Owner Demo Preview**; **Cost-first Rates Owner Preview**; then **MaterialRequirement** when authorised; **3.2.3** when authorised. Production Scope Discovery **Disabled**. Company DNA **Not Started**. PERF-FUTURE-01 **Planned**. |
