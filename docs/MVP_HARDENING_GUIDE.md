...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-09 | Stage 3.1A/3.1D Complete. Stage 3.1B **BLOCKED BY PREVIEW DEFECTS**. Stage **3.1C.1A Auth Safety Complete — Local** (error taxonomy, signup runtime config, logging). 3.1C.1B transactional signup Ready (no migration 032). | Owner Deck Preview retest; auth Preview smoke after 1A deploy; 1B provisioning still open. Production Scope Discovery off. | `docs/implementation/STAGE_3_1C1A_AUTH_SAFETY_COMPLETION.md`; `docs/audits/STAGE_3_1C_AUTH_AUDIT_CROSSCHECK.md`; `docs/runbooks/STAGE_3_1C1A_PREVIEW_AUTH_SMOKE.md` |
