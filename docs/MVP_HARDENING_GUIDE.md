...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05–2026-08-10 | **3.1C.3-R2C Complete — Local** (contractor-native rates; legacy scope $/m² demoted). | Owner Preview R2A–R2C; R2D next. Scope Discovery off. Stage 3.2 not started. | `docs/implementation/STAGE_3_1C3_R2C_RATES_ONBOARDING_COMPLETION.md` |
