...
| 2B | Authoritative Pricing Engine | In Progress | 2026-08-04 | 2026-08-04 (kernel) | Batches 2B.3A–2B.6B: commercial engine authoritative for **pricing-domain server mutations** (item CRUD, create-from-estimate, document GST aggregate, recalibration). Estimates/quotes/UI still legacy. | Next: 2B.7 estimate adoption or 2B.9 UI calculation removal. | `docs/implementation/STAGE_2B_BATCH_2B6B_COMPLETION.md`; `lib/pricing/estimate-to-pricing-adapter.ts` |
...
| Next stage | Stage 2B — Authoritative Pricing Engine (**In Progress**). Batches **2B.3A–2B.6B** complete for pricing-domain server authority. Estimates, quotes, and UI calculations remain legacy. No migrations/AI/DNA. |
