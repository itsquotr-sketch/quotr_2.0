...
| 3 | Core project workflow | In Progress | 2026-08-05 | 2026-08-05 | Stage 3.1A Complete (Preview signed off). Stage 3.1C audit Complete. Stage 3.1D Complete (Preview signed off). Stage 3.1B Ready to Plan — not started. | Authorise and plan Stage 3.1B when ready. Deferred schema proposals Not Approved. FEAT-001–003 Deferred. | `docs/implementation/STAGE_3_1A_3_1D_PREVIEW_SIGNOFF.md`; `docs/implementation/STAGE_3_1A_PRODUCT_STABILISATION_COMPLETION.md`; `docs/architecture/STAGE_3_1C_DOMAIN_MODEL_AUDIT.md`; `docs/architecture/STAGE_3_1D_DOMAIN_MODEL_REFINED.md`; `docs/implementation/STAGE_3_1D_DOMAIN_MODEL_REFINEMENT_COMPLETION.md`; `docs/plans/STAGE_3_PRODUCT_ROADMAP.md` |
...
| Next stage | Stage 3.1A and Stage 3.1D **Complete** (Preview signed off 2026-08-05 — `docs/implementation/STAGE_3_1A_3_1D_PREVIEW_SIGNOFF.md`). Stage 3.1B **Ready to Plan** — do not implement until authorised. Deferred schema proposals remain Not Approved. FEAT-001–003 remain Deferred. Stage 2B deploy/smoke remains owner-gated separately. |
