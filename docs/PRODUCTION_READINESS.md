...
- **Post-trial architecture audit (2026-08-15):** `docs/audits/POST_TRIAL_MASTER_ARCHITECTURE_AUDIT.md`. **FOUNDATION-R1 Complete / Preview regression remediated by R1-R1.** **FOUNDATION-R1-R1 Complete Local / Owner Preview Pending**. No production deploy from this batch.
