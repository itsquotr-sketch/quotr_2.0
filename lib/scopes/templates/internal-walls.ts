...
import {
  ...
  INTERNAL_WALLS_CORNICE_PLASTER_PRODUCT_OPTIONS,
...
export const internalWallsScope: ScopeDefinition = {
  ...
  questions: [
    ...
    },
    {
      ...
      label: "Openings",
      questionText: "Does this wall have any openings?",
      inputType: "select",
      options: ["No", "Yes"],
      required: false,
      priority: 23,
      estimatePriorityClass: "P0",
      factKey: "internal_walls.wall_type.has_openings",
      workAreaType: "internal_walls",
      category: "scope",
    },
    {
      ...
      label: "Opening type",
      questionText: "What kind of opening is this?",
      inputType: "select",
      options: ["Door opening", "Passage", "Other opening"],
      required: false,
      priority: 24,
      estimatePriorityClass: "P0",
    ...
    },
    {
      ...
      label: "Opening width",
      questionText: "What is the opening width?",
      inputType: "number",
      unit: "m",
      required: false,
      priority: 25,
    ...
    },
    {
      ...
      questionText: "What is the opening height?",
      inputType: "number",
      unit: "m",
      required: false,
      priority: 26,
    ...
    },
    {
      ...
      questionText: "Include wall insulation?",
      inputType: "select",
    ...
    {
      key: INTERNAL_WALLS_INSULATION_TYPE_KEY,
      label: "Insulation type",
      questionText: "What wall insulation type?",
      inputType: "select",
    ...
    },
    {
      ...
      questionText: "Include cornice/scotia?",
      inputType: "select",
    ...
    },
    {
      ...
      questionText: "Where is the cornice/scotia required?",
      inputType: "select",
    ...
    },
    {
      ...
      questionText: "What type of cornice/scotia is required?",
      inputType: "select",
    ...
    },
    {
      ...
      questionText: "Which cornice or scotia product is required?",
      inputType: "select",
      options: [...INTERNAL_WALLS_CORNICE_PLASTER_PRODUCT_OPTIONS],
      required: false,
      priority: 29.6,
      estimatePriorityClass: "P1",
    ...
    {
      key: INTERNAL_WALLS_CORNICE_NOTE_KEY,
      label: "Cornice / scotia notes",
      questionText: "Describe the custom cornice or scotia if needed.",
      inputType: "text",
      required: false,
      priority: 29.8,
      estimatePriorityClass: "P2",
    ...
    },
    {
      ...
      label: "Electrical",
      questionText: "Any electrical work associated with this wall?",
      inputType: "select",
    ...
    },
    {
      ...
      questionText: "Brief electrical allowance note?",
      inputType: "text",
      required: false,
      priority: 30.2,
      estimatePriorityClass: "P2",
    ...
    },
    {
      ...
      questionText: "Include stopping to Side A?",
      inputType: "select",
    ...
    {
      key: INTERNAL_WALLS_STOPPING_SIDE_B_KEY,
      label: "Stopping — Side B",
      questionText: "Include stopping to Side B?",
      inputType: "select",
      options: [...INTERNAL_WALLS_STOPPING_OPTIONS],
      required: false,
      priority: 31.2,
