...
import {
  ...
  CLADDING_PRODUCTIVITY_RATE_CATALOGUE,
...
export const MATERIAL_RATE_CATALOGUE: RateCatalogueEntry[] = [
  ...
  entry({
    ...
    label: "Timber retaining wall face (legacy package)",
    rate_type: "material",
    category: "material",
    work_area_type: "retaining_wall",
    workAreaLabel: "Retaining wall",
  ...
  entry({
    ...
    label: "Concrete retaining wall face (legacy package)",
    rate_type: "material",
    category: "material",
    work_area_type: "retaining_wall",
    workAreaLabel: "Retaining wall",
  ...
  entry({
    ...
    label: "Retaining wall backfill (legacy package)",
    rate_type: "material",
    category: "material",
    work_area_type: "retaining_wall",
    workAreaLabel: "Retaining wall",
