...
import {
  ...
  DOORS_HARDWARE_INSTALL_DESCRIPTION,
  ...
  DOORS_PREHUNG_INSTALL_DESCRIPTION,
  ...
  DOORS_REPLACEMENT_LEAF_INSTALL_DESCRIPTION,
...
import {
  ...
  FLOORING_HARDWOOD_REMOVE_HOURS_DESCRIPTION,
  ...
  FLOORING_SUBFLOOR_FRAMING_MAJOR_ALLOWANCE_DESCRIPTION,
  ...
  FLOORING_SUBFLOOR_FRAMING_MINOR_ALLOWANCE_DESCRIPTION,
  ...
  FLOORING_SUBFLOOR_FRAMING_STANDARD_ALLOWANCE_DESCRIPTION,
  ...
  FLOORING_VINYL_PLANK_REMOVE_HOURS_DESCRIPTION,
...
export const SHEET_SPECIFIC_MATERIAL_CATALOGUE: RateCatalogueEntry[] = [
  ...
  entry({
    item_key: "sheet.plywood.19mm.h3.2.each",
    label: "19 mm H3.2 CCA-treated structural plywood sheet",
    rate_type: "material",
    category: "material",
  ...
  entry({
    item_key: "sheet.fibre_cement.18mm.2400x1200.each",
  ...
  entry({
    item_key: "sheet.fibre_cement.tile_underlay.6mm.1800x1200.each",
    label: "6 mm Hardie Ceramic Tile Underlay 1800 × 1200",
    rate_type: "material",
    category: "material",
    workAreaLabel: "Sheet materials",
    unit: "each",
    description:
      "Shared Hardie Ceramic Tile Underlay 6 mm, 1800 × 1200 (2.16 m²/sheet). Used over 19 mm plywood when the floor finish is tile. Legacy key sheet.fibre_cement.tile_underlay.6mm.each is an alias only. No invented dollar rate — Pricing Required.",
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
...
export const FLOORING_FRAMING_ALLOWANCE_CATALOGUE: RateCatalogueEntry[] = [
  entry({
    item_key: FLOORING_SUBFLOOR_FRAMING_MINOR_ALLOWANCE_M2,
    label: FLOORING_SUBFLOOR_FRAMING_MINOR_ALLOWANCE_LABEL,
    rate_type: "allowance",
    category: "allowance",
    work_area_type: "flooring",
    workAreaLabel: "Flooring framing allowances",
    unit: "m2",
    description: FLOORING_SUBFLOOR_FRAMING_MINOR_ALLOWANCE_DESCRIPTION,
    defaultCostRate: FLOORING_SUBFLOOR_FRAMING_MINOR_ALLOWANCE_COST_EX_GST,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_SUBFLOOR_FRAMING_STANDARD_ALLOWANCE_M2,
    label: FLOORING_SUBFLOOR_FRAMING_STANDARD_ALLOWANCE_LABEL,
    rate_type: "allowance",
    category: "allowance",
    work_area_type: "flooring",
    workAreaLabel: "Flooring framing allowances",
    unit: "m2",
    description: FLOORING_SUBFLOOR_FRAMING_STANDARD_ALLOWANCE_DESCRIPTION,
    defaultCostRate: FLOORING_SUBFLOOR_FRAMING_STANDARD_ALLOWANCE_COST_EX_GST,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_SUBFLOOR_FRAMING_MAJOR_ALLOWANCE_M2,
    label: FLOORING_SUBFLOOR_FRAMING_MAJOR_ALLOWANCE_LABEL,
    rate_type: "allowance",
    category: "allowance",
    work_area_type: "flooring",
    workAreaLabel: "Flooring framing allowances",
    unit: "m2",
    description: FLOORING_SUBFLOOR_FRAMING_MAJOR_ALLOWANCE_DESCRIPTION,
    defaultCostRate: FLOORING_SUBFLOOR_FRAMING_MAJOR_ALLOWANCE_COST_EX_GST,
    calculatorSupport: "used_now",
    recommended: true,
  }),
];
...
export const BATHROOM_PRODUCTIVITY_RATE_CATALOGUE: RateCatalogueEntry[] = [
  entry({
    item_key: "bathroom.floor_substrate.install.hours_per_m2",
    label: "Bathroom floor substrate installation (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    ...
    unit: "m2",
    description:
      "Hours per m² of physical floor area. Includes measure, cut, fit, fix, and normal penetrations. Excludes demolition, major levelling, joist repair, floor finish, waterproofing, and tile underlay. Hours, not dollars.",
    defaultCostRate: 0.4,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.tile_underlay.install.hours_per_m2",
    label: "Bathroom tile underlay installation (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description:
      "Independent Quotr benchmark hours per m² of bathroom floor area for 6 mm Hardie Ceramic Tile Underlay. Includes set out, measure, cut, fit, fix, and normal penetrations. Excludes structural floor substrate, waterproofing, tiling, demolition, and major floor levelling. Not a Tier 1 Bathroom DNA task. Hours, not dollars.",
    defaultCostRate: 0.25,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    ...
    label: "Bathroom wall lining (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description:
      "Hours per m² of gross wall area. Includes measure, cut, fit, screw, and normal service penetrations. Excludes stopping, painting, tiling, demolition, and full partition framing. Hours, not dollars.",
    defaultCostRate: 0.3,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.lining.ceiling.install.hours_per_m2",
    label: "Bathroom ceiling lining (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description:
      "Hours per m² of ceiling area. Separate from wall lining productivity. Nested Bathroom ceiling lining, not a standalone Ceilings Work Area. Hours, not dollars.",
    defaultCostRate: 0.4,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.framing.install.hours_per_lm",
    label: "Bathroom local framing / nogging (hours/lm)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "lm",
    description:
      "Hours per derived lineal metre of local bathroom nogging / fixture support. Not complete partition walls. Hours, not dollars.",
    defaultCostRate: 0.2,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  ...
  entry({
    item_key: "bathroom.demolition.floor_finish.hours_per_m2",
    label: "Bathroom floor finish removal (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description:
      "Person-hours per m² of existing bathroom floor finish removal. Hours, not dollars. Not a generic demolition package.",
    defaultCostRate: 0.25,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.demolition.wall_lining.hours_per_m2",
    label: "Bathroom wall lining removal (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description: "Person-hours per m² of existing wet-area wall lining removal. Hours, not dollars.",
    defaultCostRate: 0.2,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.demolition.ceiling.hours_per_m2",
    label: "Bathroom ceiling lining removal (hours/m²)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "m2",
    description: "Person-hours per m² of existing bathroom ceiling lining removal. Hours, not dollars.",
    defaultCostRate: 0.25,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: "bathroom.demolition.vanity.hours_each",
    label: "Vanity removal (hours/each)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
  ...
  entry({
    item_key: "bathroom.demolition.toilet.hours_each",
    label: "Toilet removal (hours/each)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
  ...
  entry({
    item_key: "bathroom.demolition.shower.hours_each",
    label: "Shower / enclosure removal (hours/each)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
  ...
  entry({
    item_key: "bathroom.demolition.bath.hours_each",
    label: "Bath removal (hours/each)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
  ...
  entry({
    item_key: "bathroom.demolition.fixture.hours_each",
    label: "Generic fixture removal (hours/each)",
    rate_type: "productivity",
    category: "labour",
    work_area_type: "bathroom",
    workAreaLabel: "Bathroom productivity",
    unit: "each",
    description: "Used only when a dedicated fixture removal benchmark does not exist.",
    defaultCostRate: 0.75,
    calculatorSupport: "used_now",
    recommended: true,
  }),
...
export const BATHROOM_TRADE_ALLOWANCE_CATALOGUE: RateCatalogueEntry[] = [
  ...
  allowanceEntry({
    item_key: "bathroom.waste.minor.allowance",
    label: "Bathroom disposal — small strip-out",
    defaultCostRate: 350,
    unit: "allowance",
    description:
      "Transparent disposal allowance $350 ex GST for a small bathroom strip-out. Not a density model.",
  }),
  allowanceEntry({
    item_key: "bathroom.waste.standard.allowance",
    label: "Bathroom disposal — standard",
    defaultCostRate: 650,
    unit: "allowance",
    description:
      "Transparent disposal allowance $650 ex GST for standard bathroom demolition. Not a density model.",
  }),
  allowanceEntry({
    item_key: "bathroom.waste.major.allowance",
    label: "Bathroom disposal — major",
    defaultCostRate: 1000,
    unit: "allowance",
    description:
      "Transparent disposal allowance $1,000 ex GST for major/full strip-out. Not a density model.",
  }),
  allowanceEntry({
    item_key: "bathroom.waste.disposal.allowance",
    label: "Bathroom disposal — company override",
    defaultCostRate: 650,
    unit: "allowance",
    description:
      "Company lump replacing the derived minor/standard/major bathroom disposal allowance.",
  }),
  allowanceEntry({
    item_key: "bathroom.stopping.m2",
    label: "Bathroom stopping / plastering",
    defaultCostRate: 28,
    unit: "m2",
    trade: "plastering",
    description:
      "Nested stopping on selected new plasterboard lining area $28 ex GST / m². Company rate wins. Not a Company DNA scenario.",
  }),
  allowanceEntry({
    item_key: "bathroom.painting.m2",
    label: "Bathroom painting allowance",
    defaultCostRate: 30,
    unit: "m2",
    trade: "painting",
    description:
      "Nested prep + standard paint finish $30 ex GST / m² on paintable area. Company rate wins. Finish level does not multiply.",
  }),
];
...
export const DOORS_PRODUCTIVITY_RATE_CATALOGUE: RateCatalogueEntry[] = [
  entry({
    item_key: DOORS_PREHUNG_INSTALL_HOURS_PER_DOOR_KEY,
    label: DOORS_PREHUNG_INSTALL_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "doors",
    workAreaLabel: "Doors productivity",
    unit: "door",
    description: DOORS_PREHUNG_INSTALL_DESCRIPTION,
    defaultCostRate: DOORS_PREHUNG_INSTALL_HOURS_PER_DOOR,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: DOORS_REPLACEMENT_LEAF_INSTALL_HOURS_PER_DOOR_KEY,
    label: DOORS_REPLACEMENT_LEAF_INSTALL_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "doors",
    workAreaLabel: "Doors productivity",
    unit: "door",
    description: DOORS_REPLACEMENT_LEAF_INSTALL_DESCRIPTION,
    defaultCostRate: DOORS_REPLACEMENT_LEAF_INSTALL_HOURS_PER_DOOR,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: DOORS_HARDWARE_INSTALL_HOURS_PER_SET_KEY,
    label: DOORS_HARDWARE_INSTALL_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "doors",
    workAreaLabel: "Doors productivity",
    unit: "set",
    description: DOORS_HARDWARE_INSTALL_DESCRIPTION,
    defaultCostRate: DOORS_HARDWARE_INSTALL_HOURS_PER_SET,
    calculatorSupport: "used_now",
    recommended: true,
  }),
];

export const FLOORING_PRODUCTIVITY_RATE_CATALOGUE: RateCatalogueEntry[] = [
  entry({
    item_key: FLOORING_SUBSTRATE_INSTALL_HOURS_PER_SHEET,
    label: FLOORING_SUBSTRATE_INSTALL_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "sheet",
    description: FLOORING_SUBSTRATE_INSTALL_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_SUBSTRATE_INSTALL_HOURS_PER_SHEET_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_CARPET_REMOVE_HOURS_PER_M2,
    label: FLOORING_CARPET_REMOVE_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "m2",
    description: FLOORING_CARPET_REMOVE_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_CARPET_REMOVE_HOURS_PER_M2_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_VINYL_PLANK_REMOVE_HOURS_PER_M2,
    label: FLOORING_VINYL_PLANK_REMOVE_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "m2",
    description: FLOORING_VINYL_PLANK_REMOVE_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_VINYL_PLANK_REMOVE_HOURS_PER_M2_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_TILE_REMOVE_HOURS_PER_M2,
    label: FLOORING_TILE_REMOVE_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "m2",
    description: FLOORING_TILE_REMOVE_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_TILE_REMOVE_HOURS_PER_M2_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_HARDWOOD_REMOVE_HOURS_PER_M2,
    label: FLOORING_HARDWOOD_REMOVE_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "m2",
    description: FLOORING_HARDWOOD_REMOVE_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_HARDWOOD_REMOVE_HOURS_PER_M2_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
  entry({
    item_key: FLOORING_SUBSTRATE_REMOVE_HOURS_PER_M2,
    label: FLOORING_SUBSTRATE_REMOVE_HOURS_LABEL,
    rate_type: "productivity",
    category: "labour",
    work_area_type: "flooring",
    workAreaLabel: "Flooring productivity",
    unit: "m2",
    description: FLOORING_SUBSTRATE_REMOVE_HOURS_DESCRIPTION,
    defaultCostRate: FLOORING_SUBSTRATE_REMOVE_HOURS_PER_M2_VALUE,
    calculatorSupport: "used_now",
    recommended: true,
  }),
];
...
export const SPECIFIC_MATERIAL_RATE_GROUPS = [
  ...
  {
    title: "Flooring framing allowances",
    description:
      "Combined non-structural below-substrate framing allowance COST per m². Not timber materials and not productivity hours. Company exact allowance overrides Quotr. Nested takeoff remains unpriced until FLOORING-05.",
    entries: FLOORING_FRAMING_ALLOWANCE_CATALOGUE,
  },
  {
    title: "Painting",
    description:
