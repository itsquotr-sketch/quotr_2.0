...
export const BATHROOM_PRODUCTIVITY_RATE_CATALOGUE: RateCatalogueEntry[] = [
  entry({
    ...
    unit: "m2",
    description:
      "Hours per m² of physical floor area. Includes measure, cut, fit, fix, and normal penetrations. Excludes demolition, major levelling, joist repair, floor finish, and waterproofing. Hours, not dollars.",
    defaultCostRate: 0.4,
    calculatorSupport: "used_now",
    recommended: true,
  }),
