...
export const FENCE_INFORMATION_CONTRACT: readonly FenceInformationContractRow[] = [
  ...
  },
  {
    ...
    confidence: false,
    reason:
      "Disposal allowance when existing fence is removed. Asked in Details when demolition is included.",
  },
  {
    ...
    confidence: false,
    reason:
      "Finish included? Commercial include/exclude. No automatic money unless explicit Yes.",
  },
  {
    ...
    commercial: true,
    confidence: false,
    reason: "Paint/stain type when finish is Yes. Hidden until finish is included.",
  },
  {
    ...
    commercial: true,
    confidence: false,
    reason: "Finish sides when finish is Yes. Hidden until finish is included.",
  },
  {
