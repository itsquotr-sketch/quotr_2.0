...
- Internal walls: internal_walls.job_scope, internal_walls.length_lm, internal_walls.height_m, internal_walls.framing_type, internal_walls.wall_lining_type, internal_walls.plasterboard_type, internal_walls.lining_sides, internal_walls.insulation_included, internal_walls.skirtings_included, internal_walls.demolition_included, internal_walls.stopping_included, internal_walls.painting_included. Extract stated length, height, timber/90x45/140x45, and both-sides lining when explicit. Do not invent fire systems.
...
- "12m of 90x45 internal wall, 2.4 high, gib both sides" → internal_walls.job_scope=new_partition, internal_walls.length_lm=12, internal_walls.height_m=2.4, internal_walls.framing_type=Timber, internal_walls.lining_sides=Both sides, internal_walls.wall_lining_type=Plasterboard.
