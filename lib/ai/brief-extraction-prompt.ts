...
- Bathroom: bathroom.job_scope, bathroom.length_m, bathroom.width_m, bathroom.wall_height_m, bathroom.area_m2, bathroom.renovation_type, bathroom.demolition_required, bathroom.fixtures_client_supplied, bathroom.fixtures_included (array), bathroom.waterproofing_included, bathroom.waterproofing_extent, bathroom.tiling_included, bathroom.floor_tiling_area_m2, bathroom.wall_tiling_area_m2, bathroom.tile_extent, bathroom.floor_finish_system, bathroom.framing_level, bathroom.shower_type, bathroom.plumbing.level, bathroom.electrical.level, bathroom.underfloor_heating_included, bathroom.ventilation_included, bathroom.wall_lining_included, bathroom.floor_prep_included. If length and width are stated, extract those and do not guess area.
